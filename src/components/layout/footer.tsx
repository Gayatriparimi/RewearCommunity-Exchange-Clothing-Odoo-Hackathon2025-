      ...
      <div className="container grid grid-cols-1 gap-8 py-12 md:grid-cols-4">
        ...
        <div className="grid grid-cols-2 gap-8 md:col-span-3 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              <li><Link href="/community/blog" className="text-foreground/70 hover:text-primary">Blog</Link></li>
              <li><Link href="/community/events" className="text-foreground/70 hover:text-primary">Events</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-headline font-semibold">Legal</h4>
            <ul className="mt-4 space-y-2 text-sm">
              <li><Link href="/legal/privacy" className="text-foreground/70 hover:text-primary">Privacy Policy</Link></li>
              <li><Link href="/legal/terms" className="text-foreground/70 hover:text-primary">Terms of Service</Link></li>
              <li><Link href="/legal/contact" className="text-foreground/70 hover:text-primary">Contact</Link></li>
